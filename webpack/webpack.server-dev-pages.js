...
      },
  ...
  plugins:[
    new CleanWebpackPlugin([path.resolve(cwd,'dist/pages')], {root: path.resolve(cwd)}),
    new webpack.DefinePlugin({
      APP_BASE_URL: JSON.stringify(require('../config').baseUrl),
      APP_DEV_SERVER: JSON.stringify(require('../config').devServer)
    }),
    new (function(){
        this.apply = (compiler)=>{
